...
class Armstrong():
    ...
    @agent
    def education_planning_agent(self) -> Agent:
        return Agent(config=self.agents_config['education_planning_agent'], verbose=True, llm=Openai_llm, tools=[educational_planner_tool])
    ...
    def education_planning_task(self) -> Task:
        return Task(
            ...
            agent=self.education_planning_agent(),
            context=[self.RetirementPlannerTask(), self.goal_integration_task() ],
            output_pydantic=FullClientData
        )
    ...
    def report_generation_task(self) -> Task:
        return Task(
            ...
            context=[self.RetirementPlannerTask(), self.goal_integration_task(), self.education_planning_task() ],
